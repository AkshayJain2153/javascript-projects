...
function mealAssembly(protein, grains, veggies, beverages, desserts, numMeals) {
  ...
  for (let index = 0; index < numMeals; index++) {
    ...
    for (let currentPanatryItemIndex = 0; currentPanatryItemIndex < pantry.length; currentPanatryItemIndex++) {
      newMeal.push(pantry[currentPanatryItemIndex][index])
...
function askForNumber() {
  ...
  while (numMeals < 1 || numMeals > 6) {
    newMeal = input.question("Input doesn't work ....Please try again")
  }
